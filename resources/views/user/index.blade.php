    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row mb-3 justify-content-center">
                ...
                <div class="row mb-3">
                    {{-- Deposit card --}}
                    <div class="card btn btn-success col-md-3 text-center p-3 g-2 border-0">
                    ...
                    {{-- Withdraw card --}}
                    <div class="card btn btn-danger col-md-3 text-light text-center pt-3 p-2 g-2 border-0">
                    ...
                    {{-- Loans card --}}
                    <div class="card btn btn-warning col-md-3 text-center p-3 g-2 border-0">
                        <a href="{{ route('loan.index') }}" class="text-decoration-none text-light">
                ...
                <div class="card btn btn-secondary text-center py-3 border-0">
